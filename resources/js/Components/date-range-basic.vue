<template>
  <div :id="`dateRange${dateRangeKey}`" class="form-group d-flex align-items-center">
      <div class="date-container">
          <input
              ref="startDate"
              type="text"
              class="control half"
              data-key="ui.datagrid.filter.start_date"
              :placeholder="$t('ui.datagrid.filter.start_date')"
          />
      </div>

      <span class="middle-text" data-key="ui.datagrid.filter.to">{{ $t("ui.datagrid.filter.to") }}</span>
      ...
      <div class="date-container">
          <input
              ...
              type="text"
              class="control half"
              data-key="ui.datagrid.filter.end_date"
              :placeholder="$t('ui.datagrid.filter.end_date')"
          />
      </div>
  </div>
</template>
