    ...
    <template #header>
      ...
      <template v-for="(data, key) in columns || tableData.columns">
        <div
          ...
          v-if="data.type"
        >
          <label v-if="data.filterable">{{ $t(data.label) }}</label>
          ...
          <div class="field-container">
            ...
            <template v-else>
              <template v-if="data.filterable">
                ...
                >
                  <i class="icon add-icon ri-add-fill"></i> {{ $t(data.label) }}
                </span>
...
export default {
  ...
  methods: {
    ...
    resetAllDateRangePickers: function () {
      let datePickers = Array.from(document.querySelectorAll(".flatpickr-input"));

      datePickers.forEach((datePicker) => {
        let fp = datePicker._flatpickr;

        fp.clear(); // Clear the selected date range
    ...
    resetSpecificDateRangePicker: function (key) {
      ...
      let datePickers = Array.from(specificRangeDiv.querySelectorAll(".flatpickr-input"));
