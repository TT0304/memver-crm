                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-16 fw-semibold"></p>
                        </div>
                    </BCol>
                </BRow>
                        ...
                        <BCard no-body class="mt-4">
                            ...
                            <BCardBody class="p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Get your free memvera account now</p>
                                </div>
                                <div class="p-2 mt-4">
                                    <form class="needs-validation" novalidate>
                                        ...
                                        <div class="mb-4">
                                            <p class="mb-0 fs-13 text-muted fst-italic">By registering you agree to the
                                                Memvera <BLink href="#" class="text-primary text-decoration-underline fst-normal fw-medium">
                                                    Terms
                                                    of Use</BLink>
                                            </p>
                                        </div>
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy; {{ new Date().getFullYear() }} Memvera. Crafted with <i class="mdi mdi-heart text-danger"></i> by Memvera Team</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
