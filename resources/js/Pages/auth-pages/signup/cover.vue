                                            ...
                                            <form class="needs-validation" novalidate>
                                                ...
                                                <div class="mb-4">
                                                    <p class="mb-0 fs-13 text-muted fst-italic">By registering you agree
                                                        to the Memvera <BLink href="#" class="text-primary text-decoration-underline fst-normal fw-medium">
                                                            Terms
                                                            of Use</BLink>
                                                    </p>
                                                </div>
                ...
                <BRow>
                    <BCol lg="12">
                        <div class="text-center">
                            <p class="mb-0">&copy; {{ new Date().getFullYear() }} Memvera. Crafted with <i class="mdi mdi-heart text-danger"></i> by Memvera Team</p>
                        </div>
                    </BCol>
                </BRow>
            </BContainer>
