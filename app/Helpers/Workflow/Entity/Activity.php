...
class Activity extends AbstractEntity
{
     ...
     * Returns entity
     * 
     * @param  \App\DataStructure\Workflow\Contracts\Activity\Activity|integer  $entity
     * @return \App\DataStructure\Workflow\Contracts\Activity\Activity
     */
    public function getEntity($entity)
    {
        if (! $entity instanceof \App\DataStructure\Workflow\Contracts\Activity\Activity) {
     ...
     * @param  \App\DataStructure\Workflow\Contracts\Activity\Activity  $activity
     * @return array
     */
