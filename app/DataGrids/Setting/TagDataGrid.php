...
class TagDataGrid extends DataGrid
{
    ...
    public function prepareQueryBuilder()
    {
        $queryBuilder = DB::table('tags')
            ...
            ->leftJoin('client_users', 'tags.user_id', '=', 'client_users.id');
        ...
        $this->addFilter('user_name', 'client_users.id');
    ...
    public function prepareActions()
    {
        ...
        $this->addAction([
            ...
            'confirm_text' => trans('app.ui.datagrid.massaction.delete', ['resource' => 'source']),
            'icon'         => 'trash-icon',
        ]);
    }
